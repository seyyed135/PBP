...
namespace PBP.DataAccess.Migrations
{
    ...
    [Migration("20250502195806_UpdateDynamicListItem2Model")]
    partial class UpdateDynamicListItem2Model
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PBP.DataAccess.Models.ActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PBP.DataAccess.Models.Contact", b =>
                {
                    ...
                    b.Property<int?>("TypeOfSocialNetworkId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TypeOfSocialNetworkId");
            ...
            modelBuilder.Entity("PBP.DataAccess.Models.DynamicListItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PBP.DataAccess.Models.ActivityLog", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser<string>", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("PBP.DataAccess.Models.Contact", b =>
                {
                    b.HasOne("PBP.DataAccess.Models.DynamicListItem", "AgeGroup")
                        .WithMany()
                        .HasForeignKey("AgeGroupId");

                    b.HasOne("PBP.DataAccess.Models.DynamicListItem", "BloodType")
                        .WithMany()
                    ...
                    b.HasOne("PBP.DataAccess.Models.DynamicListItem", "PlaceOfBirth")
                        .WithMany()
                        .HasForeignKey("PlaceOfBirthId");

                    b.HasOne("PBP.DataAccess.Models.DynamicListItem", "TypeOfSocialNetwork")
                        .WithMany()
                        .HasForeignKey("TypeOfSocialNetworkId");
                    ...
                    b.Navigation("TypeOfSocialNetwork");
                });
